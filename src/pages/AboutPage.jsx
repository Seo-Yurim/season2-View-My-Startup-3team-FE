  ...
  return (
    <main className={styles.wrap}>
      ...
      <section>
        <h2>1. 프로젝트 개요</h2>
        <p>
          본 프로젝트는 Codeit FS 2기 교육과정으로 진행된 스타트업 정보 제공 및
          모의 투자 플랫폼입니다.
        </p>
        <p>
          사용자들이 스타트업을 비교하고 모의 투자를 통해 시장 분석과 예측을
          경험할 수 있도록 설계되었습니다.
          <br />이 프로젝트는 실제 투자 없이도 가상의 투자 환경에서 스타트업의
          성장을 체험할 수 있도록 돕는 것을 목표로 합니다.
        </p>
        <p>
      ...
      <section>
        ...
        <ol>
          <li>
            ...
            <p>
              <span>
                ...
                처리하여 데이터의 불일치를 방지하고 동시성 제어를 강화했습니다.
              </span>
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <p>
              <span>
                투자 금액, 매출액 등의 숫자에 3자리마다 콤마를 삽입하여 읽기
                쉽도록 표시합니다. (투자 금액 입력 시에도 실시간 적용)
              </span>
            </p>
          </li>
          <li>
            ...
            <p>
              <span>
                텍스트 버튼, 검색창, 드롭다운 메뉴 등이 모바일 화면에서도 깨지지
                않고 정상적으로 표시됩니다.
              </span>
            </p>
          </li>
          <li>
            ...
            <p>
              <span>
                팝업창이 뜰 때 입력 창에 자동으로 포커스되며, 데이터 입력 후
                버튼 클릭 없이 엔터 키를 눌러 해당 프로세스를 수행할 수 있도록
                사용자 편의성을 증대시켰습니다.
              </span>
            </p>
          </li>
